...
- Letter grades: O/A+/S=10, A=9, B+/B=8, C=7, D=6, E=5, F=0
- Percentage: 90-100→10, 80-89→9, 70-79→8, 60-69→7, 50-59→6, 40-49→5, below 40→4
- Already on 10-point scale: use as-is
- If grade shows as "AA" or similar, treat as 10
