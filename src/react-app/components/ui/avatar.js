...
function AvatarGroup({ className, ...props }) {
    return (_jsx("div", { "data-slot": "avatar-group", className: cn("[&_[data-slot=avatar]]:ring-background group/avatar-group flex -space-x-2 [&_[data-slot=avatar]]:ring-2", className), ...props }));
}
